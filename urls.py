...
urlpatterns = patterns('',
    ...
    (r'^medlem/opprett', 'medlemssys.medlem.views.create_medlem'),
    url(r'^medlem/(?P<id>\d+)/endra/(?P<nykel>\w+)', 'medlemssys.medlem.views.edit_medlem', name='medlem_edit'),
    (r'^medlem/ringjelister', 'medlemssys.medlem.views.ringjelister'),
    (r'^lokallag/$',
        'medlemssys.medlem.lokallag.home'),
    url(r'^lokallag/(?P<slug>[-\w]+)/$',
        'medlemssys.medlem.lokallag.lokallag_home', name='lokallag_home'),
    (r'^tilskiping/$',
...
#    url(r'^newsletters/', include('emencia.django.newsletter.urls')),
    ...
    url(r'^admin/medlem/giro/send/', 'medlemssys.giro.admin_views.send', name='giro_send'),
    url(r'^admin/medlem/giro/manual/', 'medlemssys.giro.admin_views.manual_girosearch', name='giro_manual'),
    url(r'^admin/revisions/', 'medlemssys.statistikk.admin_views.show_revisions', name='show_revisions'),
