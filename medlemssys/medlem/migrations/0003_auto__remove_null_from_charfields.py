...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LokallagOvervaking.epost'
        db.alter_column(u'medlem_lokallagovervaking', 'epost', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Medlem.ekstraadr'
        db.alter_column(u'medlem_medlem', 'ekstraadr', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Medlem.mellomnamn'
        db.alter_column(u'medlem_medlem', 'mellomnamn', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Medlem.innmeldingsdetalj'
        db.alter_column(u'medlem_medlem', 'innmeldingsdetalj', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Medlem.gjer'
        db.alter_column(u'medlem_medlem', 'gjer', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Medlem.bortepostnr'
        db.alter_column(u'medlem_medlem', 'bortepostnr', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Medlem.mobnr'
        db.alter_column(u'medlem_medlem', 'mobnr', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'Medlem.epost'
        db.alter_column(u'medlem_medlem', 'epost', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Medlem.heimenr'
        db.alter_column(u'medlem_medlem', 'heimenr', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

    def backwards(self, orm):

        # Changing field 'LokallagOvervaking.epost'
        db.alter_column(u'medlem_lokallagovervaking', 'epost', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Medlem.ekstraadr'
        db.alter_column(u'medlem_medlem', 'ekstraadr', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Medlem.mellomnamn'
        db.alter_column(u'medlem_medlem', 'mellomnamn', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Medlem.innmeldingsdetalj'
        db.alter_column(u'medlem_medlem', 'innmeldingsdetalj', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Medlem.gjer'
        db.alter_column(u'medlem_medlem', 'gjer', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Medlem.bortepostnr'
        db.alter_column(u'medlem_medlem', 'bortepostnr', self.gf('django.db.models.fields.CharField')(max_length=4, null=True))

        # Changing field 'Medlem.mobnr'
        db.alter_column(u'medlem_medlem', 'mobnr', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Medlem.epost'
        db.alter_column(u'medlem_medlem', 'epost', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Medlem.heimenr'
        db.alter_column(u'medlem_medlem', 'heimenr', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        ...
        u'medlem.medlem': {
            ...
            'lokallag': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['medlem.Lokallag']", 'null': 'True', 'blank': 'True'}),
            ...
            'nemnd': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['medlem.Nemnd']", 'null': 'True', 'blank': 'True'}),
            'nykel': ('django.db.models.fields.CharField', [], {'default': "'nrka6gv'", 'max_length': '255', 'blank': 'True'}),
            'oppdatert': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'oppretta': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'tilskiping': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['medlem.Tilskiping']", 'null': 'True', 'blank': 'True'}),
