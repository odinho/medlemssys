...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Giro.membership'
        db.add_column(u'medlem_giro', 'membership',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='giros', null=True, to=orm['membership.Membership']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Giro.membership'
        db.delete_column(u'medlem_giro', 'membership_id')
    ...
    models = {
        ...
        u'medlem.giro': {
            ...
            'membership': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'giros'", 'null': 'True', 'to': u"orm['membership.Membership']"}),
        ...
        u'medlem.medlem': {
            ...
            'nykel': ('django.db.models.fields.CharField', [], {'default': "'xgcduax'", 'max_length': '255', 'blank': 'True'}),
            'oppdatert': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'oppretta': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'membership.membership': {
            'Meta': {'ordering': "('-start', 'end', 'pk')", 'object_name': 'Membership'},
            'end': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'memberships'", 'to': u"orm['medlem.Medlem']"}),
