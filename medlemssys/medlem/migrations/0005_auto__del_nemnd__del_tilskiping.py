...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'medlem_nemnd')

        # Deleting model 'Tilskiping'
        db.delete_table(u'medlem_tilskiping')

        # Removing M2M table for field tilskiping on 'Medlem'
        db.delete_table(db.shorten_name(u'medlem_medlem_tilskiping'))

        # Removing M2M table for field nemnd on 'Medlem'
        db.delete_table(db.shorten_name(u'medlem_medlem_nemnd'))


    def backwards(self, orm):
        # Adding model 'Nemnd'
        db.create_table(u'medlem_nemnd', (
        ...
        db.send_create_signal(u'medlem', ['Nemnd'])

        # Adding model 'Tilskiping'
        db.create_table(u'medlem_tilskiping', (
            ('stopp', self.gf('django.db.models.fields.DateField')()),
            ('namn', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ...
        db.send_create_signal(u'medlem', ['Tilskiping'])

        # Adding M2M table for field tilskiping on 'Medlem'
        m2m_table_name = db.shorten_name(u'medlem_medlem_tilskiping')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('medlem', models.ForeignKey(orm[u'medlem.medlem'], null=False)),
            ('tilskiping', models.ForeignKey(orm[u'medlem.tilskiping'], null=False))
        ))
        db.create_unique(m2m_table_name, ['medlem_id', 'tilskiping_id'])

        # Adding M2M table for field nemnd on 'Medlem'
        m2m_table_name = db.shorten_name(u'medlem_medlem_nemnd')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('medlem', models.ForeignKey(orm[u'medlem.medlem'], null=False)),
            ('nemnd', models.ForeignKey(orm[u'medlem.nemnd'], null=False))
        ))
        db.create_unique(m2m_table_name, ['medlem_id', 'nemnd_id'])
    ...
    models = {
        ...
        u'medlem.medlem': {
            ...
            'nykel': ('django.db.models.fields.CharField', [], {'default': "'46zukek'", 'max_length': '255', 'blank': 'True'}),
            'oppdatert': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'oppretta': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
