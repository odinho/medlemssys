...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lokallag.epost'
        db.add_column(u'medlem_lokallag', 'epost',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lokallag.epost'
        db.delete_column(u'medlem_lokallag', 'epost')
    ...
    models = {
        ...
        u'medlem.medlem': {
            ...
            'nykel': ('django.db.models.fields.CharField', [], {'default': "'kavmrc3'", 'max_length': '255', 'blank': 'True'}),
            'oppdatert': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'oppretta': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
